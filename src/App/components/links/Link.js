...
class Link extends Component {
  ...
  calcSCoordinates = () => {
    ...
    // console.log("calcSCoordinates", cpt1.x, cpt1.y + halfY, this.props.end.x - SSHAPE_SIDE_WIDTH, cpt2.y);

    let coordinates = { cpt1: cpt1, cpt2: cpt2, cpt3: cpt3, cpt4: cpt4 }
    // console.log("calcSCoordinates coordinates", coordinates);
